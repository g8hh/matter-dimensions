...
var cnItems = {
    ...
    'Instead of making the game harder, Dimensional challenges provide a positive effect. If you complete the challenge, this effect becomes permanent.': '维度挑战并没有让游戏变得更难，而是提供了积极的效果。 如果您完成挑战，此效果将变为永久性。',
    ...
    'You automatically leave your Dimensional challenges on Atomic or higher resets.': '您会自动将维度挑战留在原子或更高级的重置中。',
    ...
    'You automatically leave your Vacuumic challenges on Dimensional or higher resets.': '您将自动将您的真空挑战留在维度或更高的重置。',
    'You can have 1e18 times more resources.': '你可以拥有1e18倍的资源。',
    'you can perform an additional Dimensional Shift.': '你可以执行额外的维度移位。',
...
var cnPrefix = {
    ...
    "Boost Neutron gain based on Dimensional": "提升中子增益基于维度",
