class Player {
    ...
    reset() {
        ...
        this.achievements = {};
        this.achievements["11"] = new Achievement("11", "Rough Start", "购买第1个物质维度", "check_11");
        this.achievements["12"] = new Achievement("12", "Second Thoughts", "玩1秒钟", "check_12");
        this.achievements["13"] = new Achievement("13", "Let There be Light", "产生 1 能量", "check_13");
        this.achievements["14"] = new Achievement("14", "High Five", "购买所有五个 1光子 升级", "check_14");
        this.achievements["15"] = new Achievement("15", "Formula Break", "从光子重置中获得 1 个以上的光子。\n奖励：从重置中获得 3.14 倍的光子", "check_15", "effective");
        this.achievements["16"] = new Achievement("16", "We couldn't afford 9", "拥有 6 物质", "check_16");
        this.achievements["17"] = new Achievement("17", "100 Antimatter is a lot", "拥有 100 个反物质。\n奖励：第二物质维度的生产速度提高 10%", "check_17", "effective");
        this.achievements["18"] = new Achievement("18", "Nothing Matters", "拥有0物质。\n奖励：所有物质维度产生 8 倍以上", "check_18", "effective");

        this.achievements["21"] = new Achievement("21", "Quadratic Growth", "购买第2个物质维度", "check_21");
        this.achievements["22"] = new Achievement("22", "Give me a Minute", "玩1分钟", "check_22");
        this.achievements["23"] = new Achievement("23", "Let There be Light, for real", "开始生产光", "check_23");
        this.achievements["24"] = new Achievement("24", "Explosive Breeding", "有两个以上的第一物质维度", "check_24");
        this.achievements["25"] = new Achievement("25", "Challenged", "开始1个挑战", "check_25");
        this.achievements["26"] = new Achievement("26", "Anti challenged", "完成1个挑战", "check_26");
        this.achievements["27"] = new Achievement("27", "Blink of an eye", "光子不到 200 毫秒", "check_27");
        this.achievements["28"] = new Achievement("28", "Baryon Asymmetry", "拥有0反物质。\n奖励：反物质增长 16%", "check_28", "effective");

        this.achievements["31"] = new Achievement("31", "Three is a Crowd", "购买第3个物质维度.\n奖励：如果第一物质维度自动购买器已解锁，则解锁第二物质维度自动购买器", "check_31", "effective");
        this.achievements["32"] = new Achievement("32", "Massive Consequences", "去 中子。\n奖励：你从重置中获得 20% 以上的引力子，并解锁自动化商店", "check_32", "effective");
        this.achievements["33"] = new Achievement("33", "It's useless!", "购买第三光子维度。\n奖励：第三光子维度的生产速度提高 2 倍", "check_33", "effective");
        this.achievements["34"] = new Achievement("34", "Five Star Rating", "从一次引力子重置中获得至少 5 个引力子", "check_34");
        this.achievements["35"] = new Achievement("35", "Star Citizen", "从单次光子重置中获得 100 多个光子。\n奖励：所有光子维度产生 10 倍以上", "check_35", "effective");
        this.achievements["36"] = new Achievement("36", "Zero Blinks", "没有光子重置的引力", "check_36");
        this.achievements["37"] = new Achievement("37", "Many Blinks", "不到 300 毫秒的引力", "check_37");
        this.achievements["38"] = new Achievement("38", "99.9% Uptime", "光子1000次", "check_38");

        this.achievements["41"] = new Achievement("41", "Where's the fifth?", "购买第4物质维度", "check_41");
        this.achievements["42"] = new Achievement("42", "Glass Ceiling", "达到 1e10 物质。\n奖励：你可以获得 2 倍的资源", "check_42", "effective");
        this.achievements["43"] = new Achievement("43", "There are Four Lights", "购买第四光子维度", "check_43");
        this.achievements["44"] = new Achievement("44", "Time is relative", "购买 Tick速度 升级", "check_44");
        this.achievements["45"] = new Achievement("45", "Formula Break II", "从 中子 重置中获得 1 个以上的中子。\n奖励：从 中子 重置中获得的中子是平方的", "check_45", "effective");
        this.achievements["46"] = new Achievement("46", "Contemplating the Infinite", "有一个无限的乘数来影响光的维度", "check_46");
        this.achievements["47"] = new Achievement("47", "Gravistonks", "在一次引力子重置中获得 10 个以上的引力子。\n奖励：你从重置中获得 10% 以上的引力子", "check_47", "effective");
        this.achievements["48"] = new Achievement("48", "Over in 30", "在 重力 的前 30 毫秒内反物质为零。\n奖励：反物质增长速度提高 32%", "check_48", "effective");

        this.achievements["51"] = new Achievement("51", "I feel powerful", "开始产生粒子力", "check_51");
        this.achievements["52"] = new Achievement("52", "I feel weak", "购买 10 个质子、电子和 W 玻色子。\n奖励：您最多可以购买中子粒子", "check_52", "effective");
        this.achievements["53"] = new Achievement("53", "I was never challenged", "在不到 60 毫秒内完成光子挑战 1", "check_53");
        this.achievements["54"] = new Achievement("54", "Wanna see me speed Neutronic?", "中子小于200毫秒", "check_54");
        this.achievements["55"] = new Achievement("55", "Skipping Layers", "没有光子或重力重置的中子。\n奖励：提供自动化的重力升级永远不会重置", "check_55", "effective");
        this.achievements["56"] = new Achievement("56", "Millionaire", "有一百万个第一物质维度", "check_56");
        this.achievements["57"] = new Achievement("57", "99% Downtime", "重力 100 次。\n奖励：在 重力 重置时，每获得一个 引力子 获得一次 重力 重置，最多 1e10", "check_57", "effective");
        this.achievements["58"] = new Achievement("58", "Inflation Era", "每秒产生超过 100 个空间", "check_58");

        this.achievements["61"] = new Achievement("61", "I'm So Meta", "购买 10 个第四物质维度。\n奖励：维度重置获得额外碎片", "check_61", "effective");
        this.achievements["62"] = new Achievement("62", "Matter Mayhem", "达到 1e80 物质。\n奖励：您可以最大购买光子升级", "check_62", "effective");
        this.achievements["63"] = new Achievement("63", "Event Horizon", "产生 1000 个黑洞", "check_63");
        this.achievements["64"] = new Achievement("64", "Overachiever", "在任何 重力 挑战中达到 1e100 物质。\n奖励：您最多可以购买 重力 升级", "check_64", "effective");
        this.achievements["65"] = new Achievement("65", "Nested Challenges", "在引力挑战中开始光子挑战", "check_65");
        this.achievements["66"] = new Achievement("66", "Solar Flare", "从一次光子重置中获得超过 1e8 个光子", "check_66");
        this.achievements["67"] = new Achievement("67", "The Challenging Minute", "一共完成12个挑战", "check_67");
        this.achievements["68"] = new Achievement("68", "SpaceX", "共有 10 个空间定理", "check_68");

        this.achievements["71"] = new Achievement("71", "NEW DIMENSIONS???", "购买第五物质维度", "check_71");
        this.achievements["72"] = new Achievement("72", "Hex", "购买 第六物质维度。\n奖励：解锁自动购买器以进行光子升级", "check_72", "effective");
        this.achievements["73"] = new Achievement("73", "Supernova", "购买中子维度", "check_73");
        this.achievements["74"] = new Achievement("74", "Faster than a potato", "达到 1e29/秒 tick速度", "check_74");
        this.achievements["75"] = new Achievement("75", "You got past The Big Wall", "达到1e200物质", "check_75");
        this.achievements["76"] = new Achievement("76", "This. Is. Hell.", "在引力挑战 6 和中子挑战 6 中完成光子挑战 6。\n奖励：所有质数物质维度产生 666 倍以上", "check_76", "effective");
        this.achievements["77"] = new Achievement("77", "The first one is always free", "完成每个常规 中子 挑战一次", "check_77");
        this.achievements["78"] = new Achievement("78", "Metaphor gotten", "完成一次元挑战", "check_78");

        this.achievements["81"] = new Achievement("81", "Not a luck related achievement", "购买第七物质维度", "check_81");
        this.achievements["82"] = new Achievement("82", "Limit Break", "打破无限", "check_82");
        this.achievements["83"] = new Achievement("83", "Background Radiation", "达到 2.73 K 的温度。\n奖励：解锁将 50% 的生产能量分配给加热的选项", "check_83", "effective");
        this.achievements["84"] = new Achievement("84", "Republican Victory", "获得红波", "check_84");
        this.achievements["85"] = new Achievement("85", "Paralympic Contestant", "完成引力挑战 1 或引力挑战 2", "check_85");
        this.achievements["86"] = new Achievement("86", "Why did I do this?", "同时参加两个元挑战", "check_86");
        this.achievements["87"] = new Achievement("87", "The second one is not so free", "完成任何 中子 挑战两次", "check_87");
        this.achievements["88"] = new Achievement("88", "1024 bits is not enough", "让你的资源限制超过 2^1024。\n奖励：你总是保持自动化升级不在自动化商店", "check_88", "effective");

        this.achievements["91"] = new Achievement("91", "Home Alone", "执行一次 原子 重置。\n奖励：资源限制高出 1e10 倍", "check_91", "effective");
        this.achievements["92"] = new Achievement("92", "Inseparable", "执行原子重置两次。\n奖励：维度重置的基础碎片增益加倍", "check_92", "effective");
        this.achievements["93"] = new Achievement("93", "Messing with Molecules", "执行原子重置三次。\n奖励：在原子选项卡中解锁碰撞器", "check_93", "effective");
        this.achievements["94"] = new Achievement("94", "Democratic Victory", "获得蓝波", "check_94");
        this.achievements["95"] = new Achievement("95", "Hey, it's not cold anymore!", "达到 0 °C (273.15 K, 32 °F) 的温度", "check_95");
        this.achievements["96"] = new Achievement("96", "Empty Vacuum", "真空无光子、重力或中子复位", "check_96");
        this.achievements["97"] = new Achievement("97", "The third one is kinda expensive", "完成任意 中子 挑战 3 次。\n奖励：您最多可以购买 中子 升级", "check_97", "effective");
        this.achievements["98"] = new Achievement("98", "Infinite Time", "达到 1.79e308/s tick速度", "check_98");

        this.achievements["101"] = new Achievement("101", "Combinatorial Explosion", "有 5 个碰撞点", "check_101");
        this.achievements["102"] = new Achievement("102", "Type II Civilization", "有 1e26 个光子", "check_102");
        this.achievements["103"] = new Achievement("103", "Stellar Engine", "从星星获得 50 次免费 Tick速度 升级。\n奖励：从星星获得 25% 以上的 Tick速度 升级", "check_103", "effective");
        this.achievements["104"] = new Achievement("104", "Underachiever", "在引力元挑战中达到 1e100 物质", "check_104");
        this.achievements["105"] = new Achievement("105", "Up to Eleven", "在自动化商店购买 11 次升级", "check_105");
        this.achievements["106"] = new Achievement("106", "Big Rip", "无光子、重力、中子或真空重置的维度", "check_106");
        this.achievements["107"] = new Achievement("107", "The fourth one costs a fortune", "完成任何 中子 挑战四次", "check_107");
        this.achievements["108"] = new Achievement("108", "Infinite Space", "拥有至少 1.79e308 真空能量。\n奖励：空间和真空能量不受资源限制影响", "check_108", "effective");

        this.achievements["111"] = new Achievement("111", "Unitary", "维度上至少有 11111 个碎片。\n奖励：维度重置时获得的碎片多 111%", "check_111", "effective");
        this.achievements["112"] = new Achievement("112", "Fifth Element", "获得一定等级的硼。\n奖励：从每次重置开始时解锁前四个物质维度", "check_112", "effective");
        this.achievements["113"] = new Achievement("113", "Hey, that's illegal!", "在 0 毫秒内完成光子挑战 1", "check_113");
        this.achievements["114"] = new Achievement("114", "LET THERE BE MORE LIGHT", "至少有 1.79e308 光", "check_114");
        this.achievements["115"] = new Achievement("115", "Hellscape", "达到 666 K 的温度。\n奖励：真空重置时温度不会降低", "check_115", "effective");
        this.achievements["116"] = new Achievement("116", "Gravioli", "在一次 重力 重置中获得超过 10000 个 引力子", "check_116");
        this.achievements["117"] = new Achievement("117", "The fifth one is done", "完成任何 中子 挑战五次。\n奖励：完成五次 中子 挑战将 中子 元挑战目标指数除以 10", "check_117", "effective");
        this.achievements["118"] = new Achievement("118", "The universe is full, go away!", "拥有比你的资源限制更多的空间。\n奖励：空间增益提高到 1.1 的幂，如果它高于 1/s", "check_118", "effective");

        this.achievements["121"] = new Achievement("121", "It is alive!", "达到生物。\n奖励：获得两倍以上的原子和原子碰撞知识", "check_121", "effective");
        this.achievements["122"] = new Achievement("122", "I can't see what I am doing!", "拥有超过资源限制的原子数", "check_122");
        this.achievements["123"] = new Achievement("123", "IT'S OVER 9000!", "有超过 1e9000/s 的tick速度", "check_123");
        this.achievements["124"] = new Achievement("124", "Completionist", "完整的引力元挑战", "check_124");
        this.achievements["125"] = new Achievement("125", "Particle Party", "购买 200 个质子、电子和 W-玻色子", "check_125");
        this.achievements["126"] = new Achievement("126", "This achievement doesn't exist", "至少有 9.999e9'999 物质", "check_126");
        this.achievements["127"] = new Achievement("127", "Infinite Problems", "完成一个真空挑战。\n奖励：你可以最大购买维度升级", "check_127", "effective");
        this.achievements["128"] = new Achievement("128", "Why did I do this again?", "一次参加三个元挑战", "check_128");

        this.achievements["131"] = new Achievement("131", "Genetic Investment", "购买任何可重复的生物升级", "check_131");
        this.achievements["132"] = new Achievement("132", "Breathe in...", "获得一个氧气等级", "check_132");
        this.achievements["133"] = new Achievement("133", "Nice.", "至少有 6.9e420 物质且不打破无限", "check_133");
        this.achievements["134"] = new Achievement("134", "Couple of Adjustments", "执行灭绝", "check_134");
        this.achievements["135"] = new Achievement("135", "Formula Break III", "从生物重置中获得 1 个以上的基因。\n奖励：生物重置的基础基因奖励提高到 1.618 的幂", "check_135", "effective");
        this.achievements["136"] = new Achievement("136", "Sun Vacation", "达到 5800 K 的温度", "check_136");
        this.achievements["137"] = new Achievement("137", "...breathe out", "有一个总等级至少为 1000 的元素", "check_137");
        this.achievements["138"] = new Achievement("138", "The Hindenburg", "有 10 个来自世代的免费等级", "check_138");

        this.achievements["141"] = new Achievement("141", "90 degrees from infinity", "购买第 8 个物质维度", "check_141");
        this.achievements["142"] = new Achievement("142", "Light the City!", "至少有100万人口", "check_142");
        this.achievements["143"] = new Achievement("143", "Safe Driver", "在当前生物中无需购买任何碰撞点即可达到 1e30'000 物质。\n奖励：解锁碰撞点的自动购买器和自动分配器", "check_143", "effective");
        this.achievements["144"] = new Achievement("144", "Buffed", "完成一次次元挑战", "check_144");
        this.achievements["145"] = new Achievement("145", "One Death", "达到 2.5 的死亡率", "check_145");
        this.achievements["146"] = new Achievement("146", "Metaphysics", "一次参加四个元挑战", "check_146");
        this.achievements["147"] = new Achievement("147", "Double Trouble", "完成两常规 中子 挑战五次。\n奖励：您最多可以购买原子升级", "check_147", "effective");
        this.achievements["148"] = new Achievement("148", "SpaceL", "总共有 50 个空间定理", "check_148");

        this.achievements["151"] = new Achievement("151", "Supercritical", "拥有一个总等级超过 100000 的元素。\n奖励：反应效率提高 2%", "check_151", "effective");
        this.achievements["152"] = new Achievement("152", "Exponential Millionaire", "达到 1e1'000'000 物质", "check_152");
        this.achievements["153"] = new Achievement("153", "That's even more illegal!", "在 0 毫秒内完成 引力元挑战", "check_153");
        this.achievements["154"] = new Achievement("154", "Overbuffed", "完成三维挑战", "check_154");
        this.achievements["155"] = new Achievement("155", "Fertile Beginnings", "以每分钟 100% 的增长率达到 100 人口", "check_155");
        this.achievements["156"] = new Achievement("156", "Graviyard", "在一次重力重置中获得超过 1e6 个重力", "check_156");
        this.achievements["157"] = new Achievement("157", "Triple Threat", "完成三项常规 中子 挑战五次", "check_157");
        this.achievements["158"] = new Achievement("158", "Infinite Universe", "至少有 1.79e308 个原子", "check_158");

        this.achievements["161"] = new Achievement("161", "Heresy", "购买第 9 个物质维度", "check_161");
        this.achievements["162"] = new Achievement("162", "Elemental Millionaire", "拥有一个总等级超过百万的元素", "check_162");
        this.achievements["163"] = new Achievement("163", "Abiogenesis", "在当前生物中只有一次原子重置的生物", "check_163");
        this.achievements["165"] = new Achievement("165", "Blood for the Blood God", "总共牺牲1e10人口", "check_165");
        this.achievements["167"] = new Achievement("167", "Three Challenging Minutes", "一共完成36个挑战", "check_167");
        this.achievements["168"] = new Achievement("168", "All your Neutrons belong to us", "完成中子元挑战", "check_168");
