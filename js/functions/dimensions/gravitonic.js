...
functions['gravitonic_1_pow'] = (amt_bought, amt) => {
    ...
    base_exp = me.upgrades['v93'].get_effect();

    var base_pow = base_exp.pow(amt_bought);
    // v163: boost to all Gravitonic dimensions
    if (me.upgrades['v163'].is_active()) base_pow = base_pow.mult(me.upgrades['v163'].get_effect());
    // v173: Gravitonic dimensions synergize
    if (me.upgrades['v173'].is_active()) base_pow = base_pow.mult(me.upgrades['v173'].get_effect());
    // n35: Boson power boosts Gravitonic dimensions
    if (me.upgrades['n35'].is_active()) base_pow = base_pow.mult(me.upgrades['n35'].get_effect());
    // d111: Inflation boosts 1st-3rd Gravitonic Dimensions
    if (me.upgrades['d111'].is_active()) base_pow = base_pow.mult(me.upgrades['d111'].get_effect());
...
functions['gravitonic_1_unlock'] = () => {
    ...
    if (!me.upgrades['n33'].is_active()) return false;
...
functions['gravitonic_2_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_1'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_3_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_2'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_4_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_3'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_5_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_4'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_6_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_5'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_7_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_6'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_8_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_7'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_9_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_8'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_10_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_9'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_11_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_10'].amt_bought > 0) return true;
    return false;
}
functions['gravitonic_12_unlock'] = () => {
    ...
    if (me.dimensions['gravitonic_11'].amt_bought > 0) return true;
    return false;
}